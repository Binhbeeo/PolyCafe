...
public class FileUtil {
    ...
    // API Key của ImgBB (được cung cấp bởi người dùng)
    private static final String IMGBB_API_KEY = "a0bd0fb58a6f548ec714177ba727cb77";
    private static final String IMGBB_API_URL = "https://api.imgbb.com/1/upload";

    /**
     * Tải ảnh từ request lên ImgBB và trả về URL trực tiếp của ảnh.
    ...
    /**
     * Gọi API ImgBB để upload ảnh Base64 và trả về URL
     */
